...
public class ServiceTest {
  ...
  public void requestDogTest() {
    ...
    try {
      ...
      final CompletionService<SimpleEntry<String, String>> completionService =
      ...
      for (int i = 0; i < nn; ++i) {
        final Future<SimpleEntry<String, String>> future = completionService.take();
        final SimpleEntry<String, String> result = future.get();
